  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-[10100] bg-black/80 backdrop-blur-sm border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="flex items-center justify-between zoom-header-height">
          <div className="relative">
            {/* Animated Asterisk */}
            <div className="asterisk-container">
              <span className="asterisk-main zoom-text-3xl font-bold">✦</span>
          ...
          <div className="flex items-center space-x-8">
            {navItems.map((item) => (
              <button
                ...
                className={`font-courier zoom-text-sm uppercase transition-all duration-300 ${
                  currentSection === item
                    ? 'text-white'
